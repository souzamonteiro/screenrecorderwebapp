...
# Script to generate all the icons for the Screen Recorder PWA

echo "Generating icons for the Screen Re PWA..."
...
cat > www/manifest.json << EOF
{
  ...
  "description": "Capture and save your screen recordings directly from your browser",
  "icons": [
    {
